...
$$
    ...
    source_result = snowflake.execute({sqlText:`
        ...
        FROM FOUNDATION_{{dbname}}.DOMAIN_CONFIG.DOMAIN_ITEM_METADATA_FIELD DIM_FIELD
            JOIN FOUNDATION_{{dbname}}.DOMAIN_CONFIG.DOMAIN_ITEM_METADATA_CONFIG CONFIG ON CONFIG.METADATA_FIELD_ID = DIM_FIELD.ID
            JOIN FOUNDATION_{{dbname}}.${domain_name}.SOURCES ON CONFIG.SOURCE_ID = SOURCES.ID
