...
LET count NUMBER(38,0) := (select COUNT(*) 
                            ...
                            WHERE POLICY_NAME = 'PII_MASKING_POLICY_DATE');
IF (count > 0) THEN
ALTER TAG PROTECTED_PII UNSET MASKING POLICY PII_MASKING_POLICY_DATE;
END IF;
END;
$$
;
...
ALTER TAG PROTECTED_PII SET MASKING POLICY PII_MASKING_POLICY_DATE;
